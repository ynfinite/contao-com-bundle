...
$GLOBALS['TL_LANG']['tl_ynfinite_form']['authorizationFields'] = array("Feld für Bestätigung", "Wenn Sie hier ein Feld auswählen wird die Bestätigung nur dann ausgeführt wenn das Feld ausgefüllt ist. Hier könnte eine Checkbox ausgewählt werden.");
$GLOBALS['TL_LANG']['tl_ynfinite_form']['sendAuthorizationTo'] = array("Empfänger für Bestätigugsmail", "Wählen Sie hier ein Feld mit einer E-Mail Adresse aus. Die Bestätigungsmail wird an diese Adresse versendet. Das Feld mit der E-Mail Adresse sollte im Formular ein Pflichtfeld sein.");
