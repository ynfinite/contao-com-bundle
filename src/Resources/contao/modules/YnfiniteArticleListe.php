 ...
 */
class YnfiniteArticleListModule extends \Module
{
	...
	protected function compile()
	{
		...
		while ($objArticles->next())
		{
			...
			if($objArticles->hideTroughYnfinite) {
				$showArticle = CheckArticle::doVisibilityCheck($objArticles->ynfinite_content_id, $objArticles->ynfinite_contentType, $objArticles->ynfinite_publish_field);
			}
